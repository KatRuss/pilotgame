...
public class PlaneControllerV2 : MonoBehaviour
{
    ...
    void handleInputs()
    {
        ...
        {
            throttle += plane.getAcceleration() * throttleActionValue;
    ...
    void FixedUpdate()
    {
        ...
        rb.AddForce(transform.forward * plane.getThrustMaximum() * throttle);
